...
public class PointCPTest
{
  ...
  for (int j=0; j<10; j++){
    ...
    for (int i=0; i<=2000000; i++){
      ...
      pointa = new PointCP('C',x,y);
      pointa.convertStorageToCartesian();
      
      pointa.convertStorageToPolar();
      
      
      pointa.getDistance(new PointCP('C',0.0,0.0));
      //pointa.getDistance(new PointCP('P',0.0,0.0));
    ...
    System.out.println("\n 		Elapsed time of Design 1: "+ elapsedTime + " milliseconds");
    }
  }
